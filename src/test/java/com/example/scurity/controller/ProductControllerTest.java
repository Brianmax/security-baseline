...
class ProductControllerTest {
    ...
    void findById_nonExistingId_returns404() throws Exception {
        when(productService.findById(99L)).thenThrow(new EntityNotFoundException("Product", 99L));
    ...
    void delete_nonExistingId_returns404() throws Exception {
        doThrow(new EntityNotFoundException("Product", 99L)).when(productService).delete(99L);
